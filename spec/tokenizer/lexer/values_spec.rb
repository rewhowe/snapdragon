  ...
  describe '#tokenize' do
    it 'recognizes all types of values' do
      ...
      expect(tokens).to contain_exactly(
        ...
        [Token::ARRAY_CLOSE],
        [Token::ASSIGNMENT, 'トルー', Token::VARIABLE],             [Token::RVALUE, '真', Token::VAL_BOOL],
        [Token::ASSIGNMENT, 'トルー', Token::VARIABLE],             [Token::RVALUE, '肯定', Token::VAL_BOOL],
        [Token::ASSIGNMENT, 'トルー', Token::VARIABLE],             [Token::RVALUE, 'はい', Token::VAL_BOOL],
        [Token::ASSIGNMENT, 'フォルス', Token::VARIABLE],           [Token::RVALUE, '偽', Token::VAL_BOOL],
        [Token::ASSIGNMENT, 'フォルス', Token::VARIABLE],           [Token::RVALUE, '否定', Token::VAL_BOOL],
        [Token::ASSIGNMENT, 'フォルス', Token::VARIABLE],           [Token::RVALUE, 'いいえ', Token::VAL_BOOL],
